                        ...
                        <div class="wpb_column vc_column_container vc_col-sm-12" data-equalizer-watch>
							...
							-->
                                                    <rs-layer id="slider-3-slide-13-layer-3"
                                                        ...
                                                        data-rsp_ch="on" data-xy="x:c;y:m;" data-text="w:normal;fw:700;"
                                                        data-dim="w:100%;h:100%;" data-basealign="slide"
                                                        data-frame_0="tp:600;" data-frame_1="tp:600;st:1000;sp:1500;"
							...
							-->
                                                    <rs-layer id="slider-3-slide-13-layer-1" class="Newspaper-Title"
                                                        ...
                                                        data-frame_1="tp:600;st:1000;sp:1500;" data-frame_1_mask="u:t;"
							...
							-->
                                                    <rs-layer id="slider-3-slide-13-layer-2" class="Newspaper-Subtitle"
                                                        data-type="text"
...
-->
							...
							-->
                                                    <rs-layer id="slider-3-slide-14-layer-2" class="Newspaper-Subtitle"
                                                        data-type="text"
                                                        data-color="rgba(255,210,0,1)||rgba(168,216,238,1)||rgba(168,216,238,1)||rgba(168,216,238,1)"
                                                        data-rsp_ch="on"
                                                        data-xy="xo:50px,50px,50px,30px;yo:340px,110px,80px,100px;"
                                                        data-text="s:15;l:20;fw:900;" data-frame_0="y:-100%;o:1;tp:600;"
                                                        data-frame_0_mask="u:t;" data-frame_1="tp:600;st:1000;sp:1500;"
...
-->
                                        ...
                                        if (document.readyState === "loading") {
                                            document.addEventListener('readystatechange', function() {
                                                if ((document.readyState === "interactive" || document
                                                        .readyState === "complete") && !once_revslider31) {
                            ...
                            <div class="wpb_wrapper">
                                ...
                                <section class="wd-section-blog text-center style2">
                                    <div class="wd-blog-post test  ">
                                        ...
                                        <p>
                                            Field-proven automation solutions for control, safety, wellhead, SCADA,
                                            ...
                                            <div class="">
                                                <div class="large-12 columns  wd-title-section_l">
                                                    ...
                                                    <h5>In <?php echo $name; ?>, we believe in our continuous
                                                        improvement of performances and in customer satisfaction.
                                                        Our vision is to become the market leader by providing
                                                        engineered turn-key systems to the Oil&Gas market,
                                                        performance, productivity and efficiency. Our facilities are
                                                        equipped with “state – of the art” equipment for complete
                                        ...
                                        <div class="wpb_wrapper">
                                            <div class="wpb_single_image wpb_content_element vc_align_right">
                                                ...
                                                <figure class="wpb_wrapper vc_figure">
                                                    <div class="vc_single_image-wrapper   vc_box_border_grey"><video
                                                            width="600" muted="" autoplay="" loop="" preload="auto"
                                                            sizes="(max-width: 391px) 100vw, 391px">
                                                            <source src="wp-content/uploads/oil.mp4" type="video/mp4">
                                                        </video>
                            ...
                            <div class="wpb_wrapper">
                                ...
                                <div class="">
                                    <div class="large-12 columns  wd-title-section_c">
                                        ...
                                        <h5><?php echo $name; ?> offers high-quality products and a wide range of
                                            services</h5>
                                        ...
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="wd-section-text-icon">
                                                <div class="wd-text-icon-style5  animated  " data-animated=fadeInUp>
                                                    <div class="box-icon">
                                                        <img src="wp-content/uploads/2016/01/icon11.jpg" alt="icon" />
                                                    </div>
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-3" data-equalizer-watch>
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="wd-section-text-icon">
                                                <div class="wd-text-icon-style5  animated  " data-animated=fadeInUp>
                                                    <div class="box-icon">
                                                        <img src="wp-content/uploads/2016/01/icon81.jpg" alt="icon" />
                                                    </div>
                                                    <div class="box-description">
                                                        Maximum Power </a>
                                                    </div>
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-3" data-equalizer-watch>
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="wd-section-text-icon">
                                                <div class="wd-text-icon-style5  animated  " data-animated=fadeInUp>
                                                    <div class="box-icon">
                                                        <img src="wp-content/uploads/2016/01/icon71.jpg" alt="icon" />
                                                    </div>
                                                    <div class="box-description">
                                                        Oil Resources </a>
                                                    </div>
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-3" data-equalizer-watch>
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="wd-section-text-icon">
                                                <div class="wd-text-icon-style5  animated  " data-animated=fadeInUp>
                                                    <div class="box-icon">
                                                        <img src="wp-content/uploads/2016/01/icon61.jpg" alt="icon" />
                                                    </div>
                                                    <div class="box-description">
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-3" data-equalizer-watch>
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="wd-section-text-icon">
                                                <div class="wd-text-icon-style5  animated  " data-animated=fadeInUp>
                                                    <div class="box-icon">
                                                        <img src="wp-content/uploads/2016/01/icon51.jpg" alt="icon" />
                                                    </div>
                                                    <div class="box-description">
                                                        Chemical Analysis </a>
                                                    </div>
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-3" data-equalizer-watch>
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="wd-section-text-icon">
                                                <div class="wd-text-icon-style5  animated  " data-animated=fadeInUp>
                                                    <div class="box-icon">
                                                        <img src="wp-content/uploads/2016/01/icon41.jpg" alt="icon" />
                                                    </div>
                                                    <div class="box-description">
                                                        We Fight Polution </a>
                                                    </div>
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-3" data-equalizer-watch>
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="wd-section-text-icon">
                                                <div class="wd-text-icon-style5  animated  " data-animated=fadeInUp>
                                                    <div class="box-icon">
                                                        <img src="wp-content/uploads/2016/01/icon31.jpg" alt="icon" />
                                                    </div>
                                                    <div class="box-description">
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-3" data-equalizer-watch>
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="wd-section-text-icon">
                                                <div class="wd-text-icon-style5  animated  " data-animated=fadeInUp>
                                                    <div class="box-icon">
                                                        <img src="wp-content/uploads/2016/01/icon9.jpg" alt="icon" />
                                                    </div>
                                                    <div class="box-description">
                    ...
                    <div data-vc-full-width="true" data-vc-full-width-init="false" data-vc-parallax="1.5"
                        ...
                        class="vc_row wpb_row vc_row-fluid wd-section-project vc_custom_1468841364068 vc_general vc_parallax vc_parallax-yes animation-parent"
                        style="color: #000000;">
                        <div class="wpb_column vc_column_container vc_col-sm-12" data-equalizer-watch>
                            <div class="wpb_wrapper">
                                <div class="vc_row wpb_row vc_inner vc_row-fluid row">
                                    <div class="wpb_column vc_column_container vc_col-sm-12" data-equalizer-watch>
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="">
                                                <div class="large-12 columns  wd-title-section_c">
                                                    <h2>What We Do</h2>
                                                    <h5>We provide sustainable, low-carbon energy solutions for
                                                        end users through investment, commercial production,
                                                        supply of carbon neutral fuels, renewable energy such as
                                                        Solar; Renewable power, Biofuels - Fuel Ethanol,
                                                        Biodiesel, Biogas, wind etc., while engaging in
                                                        Greenhouse Gases (GHG) emission reduction projects and
                                                        services.</h5>
                                            ...
                                            <div class="wd-section-project">
                                                ...
                                                <ul
                                                    class='masque portfolio-grid small-block-grid-1	 medium-block-grid-2 large-block-grid-3'>
                                                    <li class=" animated " data-animated=fadeInUp>
                                                        <div class="wd-project hvr-underline-from-center">
                                                            <img decoding="async" width="380" height="254"
                                                                src="wp-content/uploads/2015/11/mechanical.jpg"
                                                                class="attachment-petroleum_portfolio size-petroleum_portfolio wp-post-image"
                                                                alt="" /> <a href="mech.php">
                                                    ...
                                                    <li class=" animated " data-animated=fadeInUp>
                                                        <div class="wd-project hvr-underline-from-center">
                                                            <img decoding="async" width="380" height="254"
                                                                src="wp-content/uploads/2015/11/supplystorage.jpg"
                                                                class="attachment-petroleum_portfolio size-petroleum_portfolio wp-post-image"
                                                                alt="" /> <a href="supply.php">
                                                                <h4>Supply, Storage And Trading</h4>
                                                            </a>
                                                    ...
                                                    <li class=" animated " data-animated=fadeInUp>
                                                        <div class="wd-project hvr-underline-from-center">
                                                            <img decoding="async" width="380" height="254"
                                                                src="wp-content/uploads/2015/11/exploration.jpg"
                                                                class="attachment-petroleum_portfolio size-petroleum_portfolio wp-post-image"
                                                                alt="" /> <a href="explore.php">
                                                    ...
                                                    <li class=" animated " data-animated=fadeInUp>
                                                        <div class="wd-project hvr-underline-from-center">
                                                            <img decoding="async" width="380" height="254"
                                                                src="wp-content/uploads/2015/11/innovation.jpg"
                                                                class="attachment-petroleum_portfolio size-petroleum_portfolio wp-post-image"
                                                                alt="" /> <a href="oil.php">
                                                                <h4>Innovation And Engineering</h4>
                                                            </a>
                                                    ...
                                                    <li class=" animated " data-animated=fadeInUp>
                                                        <div class="wd-project hvr-underline-from-center">
                                                            <img decoding="async" width="380" height="254"
                                                                src="wp-content/uploads/2015/11/chemicals.jpg"
                                                                class="attachment-petroleum_portfolio size-petroleum_portfolio wp-post-image"
                                                                alt="" /> <a href="supply.php">
                                                                <h4>Chemicals And Additives</h4>
                                                            </a>
                                                    ...
                                                    <li class=" animated " data-animated=fadeInUp>
                                                        <div class="wd-project hvr-underline-from-center">
                                                            <img decoding="async" width="380" height="254"
                                                                src="wp-content/uploads/2015/11/power.jpg"
                                                                class="attachment-petroleum_portfolio size-petroleum_portfolio wp-post-image"
                                                                alt="" /> <a href="automation.php">
                                                                <h4>Power & Energy</h4>
                                                            </a>
                                ...
                                <!-- <div class="wpb_text_column wpb_content_element ">
                                    <div class="wpb_wrapper">
                                        <div class="wd-more-project animated" data-animated="flipInX"><a
                                                class="button small radius" href="index.html"><i
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-8" data-equalizer-watch>
                                        <div class="wpb_wrapper">
                                            ...
                                            <div role="form" class="wpcf7" id="wpcf7-f976-p883-o1" lang="en-US"
                                                ...
                                                <form action="#wpcf7-f976-p883-o1" method="post" class="wpcf7-form init"
