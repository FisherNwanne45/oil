...
<html class="no-js" lang="en-US">
    ...
    <head>
        ...
        .tp-caption a {
            ...
            /* Vendor-prefixed versions for legacy support */
            ...
            /* Not widely used, safe to include */
        ...
        * .custom-pagination a:hover,
        ...
        .positioned .top-bar-header .list-info-container li,
        .positioned .top-bar-header .list-info-container i {
        ...
        .vc_custom_1448972816880 {
            margin-bottom: 40px !important;
        }

        .vc_custom_1452018550256 {
            margin-top: 100px !important;
            padding-top: 110px !important;
            padding-bottom: 120px !important;
            background-image: url(wp-content/uploads/2016/01/bg4-2489e.jpg?id=895) !important;
            background-position: center !important;
            background-repeat: no-repeat !important;
            background-size: cover !important;
        }

        .vc_custom_1452018794712 {
            padding-top: 100px !important;
            padding-bottom: 100px !important;
            background-color: #f8f8f8 !important;
        }

        .vc_custom_1466431762825 {
            margin-bottom: 0px !important;
            background-color: #ffd200 !important;
        }

        .vc_custom_1448990409591 {
            margin-top: 50px !important;
        }

        .vc_custom_1464113075672 {
            margin-bottom: 0px !important;
            background-color: #ffd200 !important;
        }
        </style>
        ...
        .vc_custom_1467215196765 {
            ...
            background-image: url(wp-content/uploads/2016/01/bg-16b6d.jpg?id=1213) !important;
            background-position: center !important;
            background-repeat: no-repeat !important;
            background-size: cover !important;
        ...
        .vc_custom_1451928480699 {
            padding-top: 100px !important;
            padding-bottom: 70px !important;
        }

        .vc_custom_1468961382681 {
